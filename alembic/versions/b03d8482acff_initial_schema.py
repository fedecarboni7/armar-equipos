...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_club_invitations_id'), 'club_invitations', ['id'], unique=False)
    ...
    op.create_table('skill_votes_v2',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('player_id', sa.Integer(), nullable=True),
    sa.Column('voter_id', sa.Integer(), nullable=True),
    sa.Column('velocidad', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_skill_votes_v2_id'), 'skill_votes_v2', ['id'], unique=False)
