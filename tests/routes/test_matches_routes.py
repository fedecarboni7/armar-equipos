...
def test_create_match_and_stats(authenticated_client):
    ...
    results = {
        p["player_v1_id"] or p["player_v2_id"]: p["result"]
        for p in match_data["players"]
    }
    assert results[player_v1_id] == "win"
    assert results[player_v2_id] == "loss"
